...
\cfoot{} 
\rfoot{\scriptsize Notes} % !! Remember to change the problem set number
...
%    
\begin{document}
\title{Topic}% !! Remember to change the problem set number
\author{Holden Lee}
\date{9/??/11}% !! Remember to change the date
\maketitle
\thispagestyle{empty}
\section{}
